...
GDCdownload(query, method = "api", files.per.chunk = 100, directory="./TCGA/thca")

data <- GDCprepare(query, directory = "./TCGA/thca")
save(data, file = "data/thca.Rdata")

load("data/thca.Rdata")
...
save(all_data, file = "data/thca_alldata.Rdata")

###
rm(list = ls())
load("data/thca_alldata.Rdata")
