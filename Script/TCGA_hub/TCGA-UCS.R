...
GDCdownload(query, method = "api", files.per.chunk = 100, directory="./TCGA/ucs")

data <- GDCprepare(query, directory = "./TCGA/ucs")
save(data, file = "data/ucs.Rdata")
...
save(all_data, file = "data/ucs_alldata.Rdata")


###
rm(list = ls())
load("data/ucs_alldata.Rdata")
