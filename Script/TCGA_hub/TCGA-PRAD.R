...
GDCdownload(query, method = "api", files.per.chunk = 100, directory="./TCGA/prad")

data <- GDCprepare(query, directory = "./TCGA/prad")
save(data, file = "data/prad.Rdata")
...
save(all_data, file = "data/prad_alldata.Rdata")


###
rm(list = ls())
load("data/prad_alldata.Rdata")
