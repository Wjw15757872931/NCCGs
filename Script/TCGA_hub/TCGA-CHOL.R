...
GDCdownload(query, method = "api", files.per.chunk = 100, directory="./TCGA/chol")

data <- GDCprepare(query, directory = "./TCGA/chol")
save(data, file = "data/chol.Rdata")

load("data/chol.Rdata")
...
save(all_data, file = "data/chol_alldata.Rdata")


###
rm(list = ls())
load("data/chol_alldata.Rdata")
