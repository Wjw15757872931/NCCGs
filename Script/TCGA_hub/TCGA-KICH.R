...
GDCdownload(query, method = "api", files.per.chunk = 100, directory="./TCGA/kich")

data <- GDCprepare(query, directory = "./TCGA/kich")
save(data, file = "data/kich.Rdata")

load("data/kich.Rdata")
...
save(all_data, file = "data/kich_alldata.Rdata")


###
rm(list = ls())
load("data/kich_alldata.Rdata")
